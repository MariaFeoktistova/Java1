...
public class Worker {
        ...
        try (Connection connection = factory.newConnection();
            ...
            DeliverCallback deliverCallback = (consumerTag, delivery) -> {
                ...
                try {
                    ...
                    if (article != null) {
                        try (Connection resultConnection2 = resultFactory.newConnection();
    ...
    private Map<String, Object> fetchAndParse(String url) {
        try {
            ...
            String author = doc.selectFirst(".tm-user-info__username") != null
                    ? doc.selectFirst(".tm-user-info__username").text()
                    : "";
